...
static const char *arizona_src_mode_text[] = {
	"SAMPLE_RATE_1", "SAMPLE_RATE_2", "SAMPLE_RATE_3"
};
...
const struct soc_enum arizona_isrc1fsh_mode =
	SOC_ENUM_SINGLE(ARIZONA_ISRC_1_CTRL_1, ARIZONA_ISRC1_FSH_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_isrc1fsh_mode);

const struct soc_enum arizona_isrc1fsl_mode =
	SOC_ENUM_SINGLE(ARIZONA_ISRC_1_CTRL_2, ARIZONA_ISRC2_FSH_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_isrc1fsl_mode);

const struct soc_enum arizona_isrc2fsh_mode =
	SOC_ENUM_SINGLE(ARIZONA_ISRC_2_CTRL_1, ARIZONA_ISRC2_FSH_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_isrc2fsh_mode);

const struct soc_enum arizona_isrc2fsl_mode =
	SOC_ENUM_SINGLE(ARIZONA_ISRC_2_CTRL_2, ARIZONA_ISRC2_FSL_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_isrc2fsl_mode);

const struct soc_enum arizona_asrc1_mode =
	SOC_ENUM_SINGLE(ARIZONA_ASRC_RATE1, ARIZONA_ASRC_RATE1_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_asrc1_mode);

const struct soc_enum arizona_asrc2_mode =
	SOC_ENUM_SINGLE(ARIZONA_ASRC_RATE2, ARIZONA_ASRC_RATE2_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_asrc2_mode);

const struct soc_enum arizona_dsp1_mode =
	SOC_ENUM_SINGLE(ARIZONA_DSP1_CONTROL_1, ARIZONA_DSP1_RATE_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_dsp1_mode);

const struct soc_enum arizona_fx_mode =
	SOC_ENUM_SINGLE(ARIZONA_FX_CTRL1, ARIZONA_FX_RATE_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_fx_mode);

const struct soc_enum arizona_out_mode =
	SOC_ENUM_SINGLE(ARIZONA_OUTPUT_RATE_1, ARIZONA_OUT_RATE_SHIFT, 3,
			arizona_src_mode_text);
EXPORT_SYMBOL_GPL(arizona_out_mode);
