...
#include "device_libs/platform_s3408.h"
/*
					...
					struct devs_id *dev)
{
	...
	void *pdata = NULL;
	static int wm2000_done;

	if (!wm2000_done) {
		memset(&i2c_info, 0, sizeof(i2c_info));
		strncpy(i2c_info.type, "wm2000", sizeof(i2c_info.type));
		i2c_info.addr = 0x3a;
		i2c_register_board_info(1, &i2c_info, 1);
		wm2000_done = 1;
	}
...
static int __init sfi_parse_devs(struct sfi_table_header *table)
{
	...
	pr_info("wyh debug: i2c_register rmi devices.\n");
	i2c_register_board_info(2, s3408_i2c_info, 2);
